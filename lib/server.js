...
WalletService.prototype._getBlockchainExplorer = function(coin, network) {
    var opts = {};
    console.log("getBlockExcplore...", coin, network);
...
WalletService.prototype._getUtxosForCurrentWallet = function(opts, cb) {
    var self = this;
    console.log("_getUtxosForCurrentWallet", opts);
    var opts = opts || {};
    ...
    async.series([
        ...
        function(next) {
            ...
            console.log("WalletId", self.walletId);
        ...
        function(next) {
            ...
            console.log("axxxx", allAddresses, opts);
