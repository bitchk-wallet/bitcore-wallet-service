...
log.disableColor();
var Bitcore_org = require('bitcore-lib');
var Common = require('../common');
var Bitcore = Common.Utils.getBitCoreAll();
...
TxProposal.prototype._buildTx = function() {
    ...
    if (self.coin != 'btc') {
        var network = Bitcore_org.Networks.get(self.coin, "coin");
        t.network = network;
    }
